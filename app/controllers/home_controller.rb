...
ShopifyAPI::Asset.create(key: 'templates/collection.20.liquid', src: 'collection.20.liquid', value: "{% paginate collection.products by 20 %}
...
ShopifyAPI::Asset.create(key: 'templates/collection.30.liquid', src: 'collection.30.liquid', value: "{% paginate collection.products by 30 %}
...
ShopifyAPI::Asset.create(key: 'templates/collection.40.liquid', src: 'collection.40.liquid', value: "{% paginate collection.products by 40 %}
...
ShopifyAPI::Asset.create(key: 'templates/collection.50.liquid', src: 'collection.50.liquid', value: "{% paginate collection.products by 50 %}
